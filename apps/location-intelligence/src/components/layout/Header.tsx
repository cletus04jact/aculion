...
export default function Header({
  ...
  return (
    <header className="sticky top-0 z-20 w-full border-b border-border/80 bg-[#0d1222]/95 backdrop-blur-md px-5 py-3 shrink-0 shadow-md">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 w-full">
        
        {/* Left Side: Logo */}
        <Link to="/billboards" className="flex items-center gap-3 hover:opacity-90 transition-opacity shrink-0">
